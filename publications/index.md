...
* G. Huang, D. Chen, T. Li, F. Wu, L.J.P. van der Maaten, and K.Q. Weinberger. **Multi-Scale Dense Convolutional Networks for Resource Efficient Prediction**. In _International Conference on Learning Representations (ICLR)_, 2018. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1703.09844.pdf) <small>[[Code](https://github.com/gaohuang/MSDNet)]</small>
