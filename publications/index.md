...
1. Y. Wang, W.L. Chao, K.Q. Weinberger, L.J.P. van der Maate. **SimpleShot: Revisiting Nearest-Neighbor Classification for Few-Shot Learning**. arXiv:1911.04623, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1911.04623.pdf)
1. A. Hannun\*, B. Knott\*, S. Sengupta, and L.J.P. van der Maaten. **Privacy-Preserving Contextual Bandits**. arXiv:1901.06595, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1910.05299.pdf) <small>[[Code](https://github.com/facebookresearch/CrypTen)]</small>
...
1. C. Xie, Y. Wu, L.J.P. van der Maaten, A. Yuille, and K. He. **Feature Denoising for Improving Adversarial Robustness**. To appear in _International Conference on Computer Vision and Pattern Recognition (CVPR)_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1812.03411.pdf)
1. G. Huang, Z. Liu, G. Pleis, L.J.P. van der Maaten, and K.Q. Weinberger. **Convolutional Networks with Dense Connectivity**. To appear in _IEEE Transactions on Pattern Analysis and Machine Intelligence_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://ieeexplore.ieee.org/abstract/document/8721151)
