...
1. B. Knott, S. Venkataraman, A.Y. Hannun, S. Sengupta, M. Ibrahim, and L.J.P. van der Maaten. **CrypTen: Secure Multi-Party Computation Meets Machine Learning**. To appear in _NeurIPS Workshop on Privacy-Preserving Machine Learning_, 2020. <i class="fa fa-file-pdf-o"></i> [PDF](papers/crypten.pdf) <small>[[Code](https://crypten.ai/)]</small>
1. M. Xu, L.J.P. van der Maaten, and A.Y. Hannun. **Data Appraisal Without Data Sharing**. To appear in _NeurIPS Workshop on Privacy-Preserving Machine Learning_, 2020. <i class="fa fa-file-pdf-o"></i> [PDF](papers/appraisal.pdf)
1. K.R. Allen\*, A. Bakhtin\*, K. Smith, J. Tenenbaum, and L.J.P. van der Maaten. **OGRE: An Object-Based Generalization for Reasoning Environment**. To appear in _NeurIPS Workshop on Object Representations for Learning and Reasoning_, 2020. <i class="fa fa-file-pdf-o"></i> [PDF](papers/ogre.pdf) <small>[[Code](https://github.com/facebookresearch/phyre/blob/master/agents/OGRE.md)]</small>
