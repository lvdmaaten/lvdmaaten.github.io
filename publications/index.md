...
1. B. Knott, S. Venkataraman, A.Y. Hannun, S. Sengupta, M. Ibrahim, and L.J.P. van der Maaten. **CrypTen: Secure Multi-Party Computation Meets Machine Learning**. To appear in _NeurIPS Workshop on Privacy-Preserving Machine Learning_, 2020. <i class="fa fa-file-pdf-o"></i> [PDF](papers/crypten.pdf)
1. K.R. Allen*, A. Bakhtin*, K. Smith, J. Tenenbaum, and L.J.P. van der Maaten. **OGRE: An Object-Based Generalization for Reasoning Environment**. To appear in _NeurIPS Workshop on Object Representations for Learning and Reasoning_, 2020. <i class="fa fa-file-pdf-o"></i> [PDF](papers/ogre.pdf)
...
1. Y. Wang, Z. Lai, G. Huang, B.H. Wang, L.J.P. van der Maaten, M. Campbell, and K.Q. Weinberger. **Anytime Stereo Image Depth Estimation on Mobile Devices**. To appear in _International Conference on Robotics and Automation (ICRA)_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1810.11408.pdf) <small>[[Code](https://github.com/mileyan/AnyNet)]</small>
1. A. Dubey, L.J.P. van der Maaten, Z. Yalniz, Y. Li, and D. Mahajan. **Defense Against Adversarial Images using Web-Scale Nearest-Neighbor Search**. To appear in _International Conference on Computer Vision and Pattern Recognition (CVPR)_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1903.01612.pdf)
1. C. Xie, Y. Wu, L.J.P. van der Maaten, A. Yuille, and K. He. **Feature Denoising for Improving Adversarial Robustness**. To appear in _International Conference on Computer Vision and Pattern Recognition (CVPR)_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](https://arxiv.org/pdf/1812.03411.pdf) <small>[[Code](https://github.com/facebookresearch/ImageNet-Adversarial-Training)]</small>
1. G. Huang, Z. Liu, G. Pleis, L.J.P. van der Maaten, and K.Q. Weinberger. **Convolutional Networks with Dense Connectivity**. To appear in _IEEE Transactions on Pattern Analysis and Machine Intelligence_, 2019. <i class="fa fa-file-pdf-o"></i> [PDF](http://www.gaohuang.net/papers/DenseNet_Journal.pdf)
